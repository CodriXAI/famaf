...
int main(void) {
    struct testcase tests[N_TESTCASES] = {
        ...
        {5,{blue,red,white,red,white}, {red,red,white,blue,white}}, //Pruebo este para ver si detecta errores
        {3,{blue,red,white}, {red,white,blue}},
        {4, {white,white,white,red}, {red,white,white,white}},
        {4, {blue,white,blue,red}, {red,white,blue,blue}},
        {3, {red,blue,blue},{red,blue,blue}}
    };
