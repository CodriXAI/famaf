...
void test_head() {
    ...
    struct head_testcase tests[N_TESTCASES_HEAD] = {
      ...
      //Test de Cris:
      {{2, 1, 2}, 3, 2},        // testea: head([2,1,2]) == 2
      {{4, 4, 4, 4}, 4 ,4},     // testea: head([4,4,4,4]) == 4
    };
...
void test_index() {
    ...
    struct index_testcase tests[N_TESTCASES_INDEX] = {
      ...
      //Test de Cris:
      { {2, 2, 2}, 3, 0, 2},        // testea: index([2,2,2]) == 2
      { {2, 2, 2}, 3, 1, 2},        // testea: index([2,2,2]) == 2
    };
...
void test_length() {
    ...
    struct length_testcase tests[N_TESTCASES_LENGTH] = {
      ...
      { {2, 2, 2, 2, 2, 2, 2}, 7}, // testea: length([2,2,2,2,2,2,2]) == 7
      { {3,1}, 2} //testea: length([3,1]) == 2
    };
